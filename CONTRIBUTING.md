...
You can report issues [here](https://github.com/vasmalltalk/paho-mqtt-vast/issues/new)

## Contributing Code
- This project is MIT licensed, so any code contribution MUST be under the same license.
- This project uses [Semantic Versioning](http://semver.org/), so keep it in mind when you make backwards-incompatible changes. If some backwards incompatible change is made the major version MUST be increased.
- The c source code is hosted in this repository in the `cSource` folder.
- The smalltalk source code is hosted in this repository using the Tonel format in the `stSource` folder.
